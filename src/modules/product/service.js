 ...
 * @returns {*}
 */
export const getRatingProductReviews = product_id => request.get(`/${PLUGIN_NAME}/v1/rating-count?product_id=${product_id}`);

/**
 *  Get rating product reviews
 * @returns {*}
 */
export const addProductReviews = data => request.post(`/${PLUGIN_NAME}/v1/reviews`, data);
